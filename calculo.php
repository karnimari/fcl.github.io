...
$para = 'karnimari@hotmail.com';
$asunto = 'test';

mail('karnimari@hotmail.com','Mensaje de la web', utf8_decode($mensaje), $header);

if(mail('karnimari@hotmail.com', 'Mensaje de la web', 'PruebaM', 'Header'))
